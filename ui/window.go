...
import (
	...
	"github.com/gord-project/gord/fileopen"
	"github.com/gord-project/gord/logging"
	"github.com/gord-project/gord/util/files"
	"github.com/gord-project/gord/util/fuzzy"
	"github.com/gord-project/gord/util/text"
	...
	"github.com/gord-project/gord/scripting/js"
	...
	"github.com/gord-project/gord/util/maths"
)
...
func getWelcomeText() string {
	return fmt.Sprintf(splashText+WelcomeText, version.Version)
}
...
func (window *Window) LoadChannel(channel *discordgo.Channel) error {
	...
	window.DisplaySlowmode(channel.RateLimitPerUser, channel.RateLimitPerUser)
...
func (window *Window) DisplaySlowmode(currentTime, totalTime int) {
	...
	// if relevant, display remaining countdown time
	currentAmount := ""
	if currentTime == 0 {
